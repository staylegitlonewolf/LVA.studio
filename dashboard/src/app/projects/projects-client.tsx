...
export default function ProjectsClient() {
  ...
  return (
    <main className="bg-atmosphere min-h-screen">
      <header className="max-w-7xl mx-auto px-6 py-6 space-y-4">
        <div className="topbar">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="topbar-subtitle">Projects Home</p>
              <h1 className="topbar-title">AI Control Center (BETA)</h1>
            </div>
          </div>
          <div className="flex items-center gap-3">
        ...
        <div className="surface-panel px-4 py-3 flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-[var(--color-muted)]">
            <span>Search</span>
          </div>
          <div className="flex-1 min-w-[240px]">
            <input className="input-field" placeholder="Search projects, templates, or members..." />
          </div>
